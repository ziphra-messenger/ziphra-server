package ar.ziphra.server.component.common;
...
public class ControllerBaseUtil {
	...
	protected final ResponseEntity<String> checkServers(String txtLog, HealthCheckerServerType server, ExceptionReturnCode code ) throws ZiphraException {
	...
	protected final ResponseEntity<String> checkServersSessionManager() throws ZiphraException{
	...
	protected final ResponseEntity<String> checkServersRequestId() throws ZiphraException{
		return checkServers("REQUESTID_OFFLINE", HealthCheckerServerType.REQUEST_ID, ExceptionReturnCode.REQUEST_ID_OFFLINE  );
	}
	
	protected final ResponseEntity<String> checkServersMessageId() throws ZiphraException{

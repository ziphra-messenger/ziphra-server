...
import ar.ziphra.common.dto.response.GrupoRemoveMeResponseDTO;
import ar.ziphra.common.dto.response.InitGrupoResponse;
...
import ar.ziphra.core.model.GrupoGralConfLock;
import ar.ziphra.core.model.GrupoGralConfPassword;
...
public class GrupoProcessService  {
	...
	public GrupoDTO getGrupoDTO(Usuario u, UserForGrupo v) throws ZiphraException {
...
//	}
	...
	public void  sentInvitation(Grupo grupo, GrupoRolesEnum role,String message, Usuario logU,Usuario UserInvitationCode, AES aes) throws ZiphraException {
		Grupo g = new Grupo();
...
//
//	private void removeMeAnonimo(Usuario usuarioLogged, Grupo grupo) throws ZiphraException {

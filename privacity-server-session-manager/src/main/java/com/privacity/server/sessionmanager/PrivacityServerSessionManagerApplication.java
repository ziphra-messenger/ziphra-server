package com.privacity.server.sessionmanager;
...
@ComponentScan(basePackages = "com.privacity.server.sessionmanager")
//@ComponentScan(basePackages = "com.privacity.server.security")
//@ComponentScan(basePackages = "com.privacity.server")
public class PrivacityServerSessionManagerApplication {

	public static void main(String[] args) {
		SpringApplication.run(PrivacityServerSessionManagerApplication.class, args);
	}

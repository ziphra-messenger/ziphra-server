...
public class ProducersGenerator {
    ...
    @Value("${com.privacity.server.sessionmanager.util.pool.ProducersGenerator.keyMinLenght}")
    private Integer keyMinLenght;
    @Value("${com.privacity.server.sessionmanager.util.pool.ProducersGenerator.keyMaxLenght}")
    private Integer keyMaxLenght;
    @Value("${com.privacity.server.sessionmanager.util.pool.ProducersGenerator.saltMinLenght}")
    private Integer saltMinLenght;
    @Value("${com.privacity.server.sessionmanager.util.pool.ProducersGenerator.saltMaxLenght}")
    private Integer saltMaxLenght;
    @Value("${com.privacity.server.sessionmanager.util.pool.ProducersGenerator.iterationMinValue}")
    private Integer iterationMinValue;
    @Value("${com.privacity.server.sessionmanager.util.pool.ProducersGenerator.iterationMaxValue}")
    private Integer iterationMaxValue;
    @Value("${com.privacity.server.sessionmanager.util.pool.ProducersGenerator.bits}")
    private Integer bits;
    @Value("${com.privacity.server.sessionmanager.util.pool.ProducersGenerator.randomGeneratorType}")

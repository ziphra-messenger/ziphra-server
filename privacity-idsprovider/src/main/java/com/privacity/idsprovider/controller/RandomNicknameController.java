...
import com.privacity.idsprovider.components.RandomNicknameComponent;
...
public class RandomNicknameController {
	...
	public Map<Long,String> getByGrupo(@PathVariable String idGrupo) throws PrivacityException, Exception  {
	...
	public Map<String,String> refreshByGrupo(@RequestParam String idGrupo) throws PrivacityException, Exception  {
		return null;

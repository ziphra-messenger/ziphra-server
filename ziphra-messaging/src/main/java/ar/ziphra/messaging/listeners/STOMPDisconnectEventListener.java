package ar.ziphra.messaging.listeners;
...
public class STOMPDisconnectEventListener  implements ApplicationListener<SessionDisconnectEvent>{
    ...
    public void onApplicationEvent(SessionDisconnectEvent event) {
        ...
        for ( String sessionsss : uf.socketSessionRegistry().getSessionIds(username) ) {
        	uf.socketSessionRegistry().unregisterSessionId(username,sessionsss);	
        }

package ar.ziphra.messaging.configuration;
...
public class UsuarioSessionInfoService {
	...
	public String encryptProtocoloWS(String username, ProtocoloDTO p, String url) throws ZiphraException {
		try {
...
//			HttpEntity<?> entity = new HttpEntity<Object>(map);
	...
	@SuppressWarnings("deprecation")
	public Map<String, String> encryptProtocoloWS(Queue<String> userslist, ProtocoloDTO p, String url) throws ZiphraException {
		try {
			RestTemplate rest = new RestTemplate();

...
public class UsuarioSessionInfoService {
	...
	public Map getRequestIds(String username) {
		...
		Map r = rest.postForObject(urlService + CONSTANT_URL   + "/requestId/getAll", map, Map.class);
	...
	public AESAllDTO getAesDtoAll(String username) {
		...
		AESAllDTO r = rest.postForObject(urlService + CONSTANT_URL+"/get/AesDtoAll", map, AESAllDTO.class);
	...
	public void remove(String username) {
		...
		rest.postForObject(urlService + CONSTANT_URL+"/remove/session", map, Object.class);
	...
	public String decryptSessionAESServerIn(String username, String obj, String className) {
		...
		String r = rest.postForObject(urlService + CONSTANT_URL+"/encryption/decrypt/sessionAESServerIn", map, String.class);
	...
	public ProtocoloDTO decryptProtocolo(String username, String obj, String url) {
		...
		ProtocoloDTO r = rest.postForObject(urlService + CONSTANT_URL+"/encryption/decrypt/protocolo", map, ProtocoloDTO.class);
	...
	public String encryptProtocolo(String username, String obj, String url) {
		...
		String r = rest.postForObject(urlService + CONSTANT_URL+"/encryption/encrypt/protocolo", map, String.class);
	...
	public String encryptSessionAESServerOut(String username, String obj) {
		...
		String r = rest.postForObject(urlService + CONSTANT_URL+"/encryption/encrypt/sessionAESServerOut", map, String.class);
...
//	}
	public Object privacityIdServiceDecrypt(String username, Object dtoObject, String className) throws Exception, ClassNotFoundException {
		...
		Object r = rest.postForObject(urlService + CONSTANT_URL+"/encryption/decrypt/ids", map, Class.forName(className));
	...
	public String privacityIdServiceEncrypt(String username, Object dtoObject, String className) {
		...
		String r = rest.postForObject(urlService + CONSTANT_URL+"/encryption/encrypt/ids", map, String.class);
	...
	public Object privacityIdServiceEncrypt2(String username, Object dtoObject, String className) throws Exception, ClassNotFoundException {
		...
		Object r = rest.postForObject(urlService + CONSTANT_URL+"/encryption/encrypt/ids", map, Class.forName(className));
	...
	public void putRequestId(String username, String requestIdClientSide, RequestIdDTO serverRequestIdDTO) {
		...
		rest.postForObject(urlService + CONSTANT_URL+"/requestId/add", map, Object.class);

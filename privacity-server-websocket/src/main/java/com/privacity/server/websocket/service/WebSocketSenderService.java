package com.privacity.server.websocket.service;
...
import com.privacity.server.websocket.pool.WsQueue;
...
//	}
	...
	public  int getMembersOnlineByGrupo(String idGrupoS) throws Exception {

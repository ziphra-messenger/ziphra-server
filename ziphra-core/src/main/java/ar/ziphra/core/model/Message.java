...
public class Message implements Serializable {
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "messageDetailId.message", cascade = CascadeType.ALL) // don't fetch
																										// immediately
																										// in order to
																										// use power of
																										// caching
	...
	@OneToOne(fetch = FetchType.LAZY, mappedBy = "mediaId.message", cascade = CascadeType.ALL) // don't fetch

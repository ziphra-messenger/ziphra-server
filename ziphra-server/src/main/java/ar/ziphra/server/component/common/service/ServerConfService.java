package ar.ziphra.server.component.common.service;
...
import ar.ziphra.common.dto.servergralconf.PasswordConfigDTO;
import ar.ziphra.common.dto.servergralconf.PasswordRulesDTO;
import ar.ziphra.common.dto.servergralconf.SGCAESDTO;
import ar.ziphra.common.dto.servergralconf.SGCAESSimple;
import ar.ziphra.common.dto.servergralconf.SGCAsymEncrypt;
import ar.ziphra.common.dto.servergralconf.SGCAuth;
import ar.ziphra.common.dto.servergralconf.SGCExtrasDTO;
...
import ar.ziphra.common.dto.servergralconf.SGCServerInfo;
...
public class ServerConfService {
	...
	// ziphraIdAES
	@Value("${serverconf.ziphraIdAes.keyMinLenght}")
	private int ziphraIdAES_keyMinLenght;
	@Value("${serverconf.ziphraIdAes.keyMaxLenght}")
	private int ziphraIdAES_keyMaxLenght;
	@Value("${serverconf.ziphraIdAes.saltMinLenght}")
	private int ziphraIdAES_saltMinLenght;
	@Value("${serverconf.ziphraIdAes.saltMaxLenght}")
	private int ziphraIdAES_saltMaxLenght;	
	@Value("${serverconf.ziphraIdAes.iterationMinValue}")
	private int ziphraIdAES_iterationMinValue;
	@Value("${serverconf.ziphraIdAes.iterationMaxValue}")
	private int ziphraIdAES_iterationMaxValue;
	@Value("${serverconf.ziphraIdAes.bits}")
	private int ziphraIdAES_bits;
	@Value("${serverconf.ziphraIdAes.randomGeneratorType}")
	private RandomGeneratorType ziphraIdAES_randomGeneratorType;

	// ziphraIdAESOn
	@Value("${serverconf.ziphraIdAESOn}")	
	private boolean ziphraIdAESOn;
	...
	private void buildSystemGralConf() {
		...
		c.setZiphraIdAES(new SGCAESDTO());
		c.getZiphraIdAES().setBits(ziphraIdAES_bits);
		c.getZiphraIdAES().setIterationMaxValue(ziphraIdAES_iterationMaxValue);
		c.getZiphraIdAES().setIterationMinValue(ziphraIdAES_iterationMinValue);
		c.getZiphraIdAES().setKeyMaxLenght(ziphraIdAES_keyMaxLenght);
		c.getZiphraIdAES().setKeyMinLenght(ziphraIdAES_keyMinLenght);
		c.getZiphraIdAES().setRandomGeneratorType(ziphraIdAES_randomGeneratorType);
		c.getZiphraIdAES().setSaltMaxLenght(ziphraIdAES_saltMaxLenght);
		c.getZiphraIdAES().setSaltMinLenght(ziphraIdAES_saltMinLenght);
		c.getZiphraIdAES().setRandomGeneratorType(ziphraIdAES_randomGeneratorType);
		
		c.setZiphraIdAESOn(ziphraIdAESOn);

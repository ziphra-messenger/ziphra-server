package ar.ziphra.server.component.auth;
...
import ar.ziphra.server.component.encryptkeys.RSAComponent;
...
//	}
		...
		//String userIdEnc = ziphraIdServices.getAES(usuarioDB.getIdUser().toString());
		...
		data= gson.fromJson( comps.service().usuarioSessionInfo().ziphraIdServiceEncrypt(usuarioDB.getUsername()
				, data
...
//		
	...
	public void registerUser(Usuario usuario, RolesSecurityAccessToServerEnum erole) throws ZiphraException {

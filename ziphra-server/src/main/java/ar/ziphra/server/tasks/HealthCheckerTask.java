...
public class HealthCheckerTask extends HealthCheckerTaskAbstract{
	...
	@Value("${ar.ziphra.server.tasks.healthChecker.serverMessaging}")
	...
	@Value("${ar.ziphra.server.tasks.healthChecker.serverRequestId}")
	private String serverRequestId;

	@Value("${ar.ziphra.server.tasks.healthChecker.serverIdsProvider}")

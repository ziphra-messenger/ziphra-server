package com.privacity.server.loadbalance.messageid;
...
@ComponentScan(basePackages = "com.privacity.server.loadbalance.messageid")
//@ComponentScan(basePackages = "com.privacity.server.security")
//@ComponentScan(basePackages = "com.privacity.server")
public class PrivacityServerLoadBalanceMessageIdApplication {

	public static void main(String[] args) {
		SpringApplication.run(PrivacityServerLoadBalanceMessageIdApplication.class, args);
	}

...
import com.privacity.server.common.util.MathBaseConverter;
import com.privacity.server.common.util.MixBytesUtil;
import com.privacity.server.common.util.MutateDigitUtil;

import lombok.Data;


@Data
public class PrivacityIdServices  implements Serializable{
	...
	public PrivacityIdServices(boolean privacityIdAESOn, AESDTO aesDTO )throws Exception {
		{
			...
			privacityIdOrderSeed = 123123 ; //RandomGenerator.betweenTwoNumber(1483647,7483647);

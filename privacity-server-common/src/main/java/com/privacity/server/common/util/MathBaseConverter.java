package com.privacity.server.common.util;
...
public class MathBaseConverter {
	...
	public static long convertirBase10(String to10){

		return convertirBase10(CONSTANT_BASE_MAX, to10);
	}

	public static long convertirBase10(int base, String to10){
	...
	public static String convertirBaseN(long num){
		return convertirBaseN(CONSTANT_BASE_MAX, num );
	}
	public static String convertirBaseN(int base,long num){
		if (num == 0 ) return "0";
		String salida = "";
		long div=num, mod=0;
		while(num>=base){
	...
	private static int charAt2(String pos){

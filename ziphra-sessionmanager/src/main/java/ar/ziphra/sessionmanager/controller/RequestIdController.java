...
public class RequestIdController {
	...
	public void requestIdPrivateAdd(@RequestParam String username, @RequestParam String requestIdClientSide, @RequestParam String serverRequestIdDTO) throws ZiphraException, ZiphraException{
	...
	public Map<String,RequestIdDTO> requestIdPrivateGetAll(@RequestParam String username) throws ZiphraException {

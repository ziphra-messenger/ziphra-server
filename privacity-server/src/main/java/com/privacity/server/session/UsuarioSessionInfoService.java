...
//    }
    ...
    public Object encryptIds(String username, Object object) throws Exception {
    	this.get(username,false).getPrivacityIdServices().encryptIds(object);
    	return object;
    }
    
    public Object decryptIds(String username, Object object) throws Exception {
    	this.get(username,false).getPrivacityIdServices().decryptIds(object);
    	return object;
    }

    
    public AESDTO getSessionAesDTO(String username, boolean create) throws Exception {
    	return this.get(username,create).getSessionAES();

    }
    public AESDTO getSessionAesDTO(String username) throws Exception {
    	return this.get(username,false).getSessionAES();

    }
    
    public AESDTO getSessionAESToUseWS(String username) throws Exception {
    	return this.get(username,false).getSessionAESToUseWS().getAESDTO();

    }
    
    public AESDTO getSessionAESToUseServerEncrypt(String username) throws Exception {
    	return this.get(username,false).getSessionAESToUseServerEncrypt().getAESDTO();

    }
    
    public PublicKey getPublicKey(String username) throws Exception {
    	return this.get(username,false).getPublicKey();

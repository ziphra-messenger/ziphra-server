package com.privacity.server.messageidgenerator;
...
@ComponentScan(basePackages = "com.privacity.server.messageidgenerator")
//@ComponentScan(basePackages = "com.privacity.server.security")
//@ComponentScan(basePackages = "com.privacity.server")
public class PrivacityServerMessageIdGeneratorApplication {

	public static void main(String[] args) {
		SpringApplication.run(PrivacityServerMessageIdGeneratorApplication.class, args);
	}
